...
if __name__ == '__main__':
    ...
    set_seed(418)
    # TODO: 
    result_folder = "/media/coolboy-3/chb/DeepFaker/D3/results/vqdm_val"
    checkpoint = "/media/coolboy-3/chb/DeepFaker/D3/ckpt/classifier.pth"
    # TODO: Your test/evaluation image folder containing "real" and "fake" subfolders
    test_folders = [
        "/media/coolboy-3/chb/DeepFaker/datasets/GenImage_VQDM_val_2cls"
    ]
    batch_size = 128
